...
<body>
    <table class="easyui-datagrid" id="dg"  pagination="true" rownumbers="true" fitColumns="true" fit="true" singleSelect="true" toolbar="#toolbar">
        <thead>
            <tr>
                <th data-options="field:'kode_jabatan',sortable:true, width: 20">Kode Jabatan</th>
                <th 
                data-options="field:'nama_jabatan',sortable:true, width:200,
                  editor:{
                    type:'validatebox',
                    options:{
                        required:true
